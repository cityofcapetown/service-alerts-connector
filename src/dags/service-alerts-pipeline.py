...
with kubernetes_dag.airflowK8sDAG("service-alerts-pipeline",
    ...
    augment_data_operator = dag.get_dag_operator("augment-service-alerts",
                                                 ...
                                                 startup_timeout_seconds=600,
                                                 task_concurrency=1, )
    all_broadcast_data_operator = dag.get_dag_operator("broadcast-service-alerts",
                                                       "python3 cct_connector/ServiceAlertBroadcaster.py",
                                                       resources=kubernetes_dag.LIGHT_RESOURCES,
                                                       startup_timeout_seconds=600,
                                                       task_concurrency=1, )
    week_broadcast_data_operator = dag.get_dag_operator("broadcast-service-alerts",
                                                        "python3 cct_connector/ServiceAlert7DaysBroadcaster.py",
                                                        resources=kubernetes_dag.LIGHT_RESOURCES,
                                                        startup_timeout_seconds=600,
                                                        task_concurrency=1, )
    current_broadcast_data_operator = dag.get_dag_operator("broadcast-service-alerts",
